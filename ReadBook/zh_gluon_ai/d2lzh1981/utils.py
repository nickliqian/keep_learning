...
def load_data_fashion_mnist(batch_size, resize=None, root='~/Datasets/FashionMNIST'):
    ...
    if sys.platform.startswith('win'):
        ...
        num_workers = 4
    train_iter = torch.utils.data.b(mnist_train, batch_size=batch_size, shuffle=True, num_workers=num_workers)
    test_iter = torch.utils.data.DataLoader(mnist_test, batch_size=batch_size, shuffle=False, num_workers=num_workers)
...
def resnet18(output=10, in_channels=3):
    net = nn.Sequential(
        ...
        nn.BatchNorm2d(64), 
        nn.ReLU(),
        nn.MaxPool2d(kernel_size=3, stride=2, padata_iter_consecutivedding=1))
